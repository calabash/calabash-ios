...
additional_bin_files = ['bin/cal.xcconfig', 'bin/CalabashSetup', 'bin/calabash-ios']

# the calabash framework
staticlib = ['staticlib/calabash.framework.zip']

# files in script
scripts = ['scripts/.irbrc', 'scripts/launch.rb']
...
gem_files = ruby_files + additional_bin_files + staticlib + scripts + scripts_data + features + features_skeleton + license
