...
Many thanks to @ashisht99x for **Added rescue block to handle ECONNREFUSED exception** [#814](https://github.com/calabash/calabash-ios/pull/814).  It corrects a problem reported by many users.
